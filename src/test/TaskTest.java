...
class TaskTest {
    ...
    void addNTestTask() {
        ...
        number.increment(); //
        numberTask.put(number.getCount(), new ManagerStatus(TypeTask.TASK, "Изучить Java", Status.INPROGRESS, testTask1, null, null, null));// сохранили в таблицу

        number.increment(); //
        numberTask.put(number.getCount(), new ManagerStatus(TypeTask.TASK, "Изучить Java", Status.INPROGRESS, testTask2, null, null, null)); // сохранили в таблицу
